...
export const TimelineEventModal: FC<TimelineEventModalProps> = ({
  ...
  return (
    <motion.div
      className="fixed inset-0 z-[var(--z-modal)] flex items-center justify-center safe-area-all"
      initial={{ opacity: 0 }}
      animate={{ opacity: 1 }}
      exit={{ opacity: 0 }}
      ...
      >
        ...
        <button
          ...
          className={cn(
            ...
            'w-11 h-11 rounded-full touch-target', // 44px touch target
